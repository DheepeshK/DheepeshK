  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 md:px-8 flex items-center justify-between">
        ...
        >
          <span className="font-bold tracking-tight text-white text-lg group-hover:text-emerald-400 transition-colors">
            {name}
          </span>
        </div>
        ...
        <div className="hidden sm:flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-1.5 rounded-full text-xs font-semibold tracking-wide bg-zinc-900 hover:bg-zinc-900 hover:border-zinc-700 text-zinc-200 border border-zinc-800 transition-all shadow-md shadow-black/10 group active:scale-95 cursor-pointer"
          >
            ...
            <div className="px-4 py-6 space-y-4 max-h-[80vh] overflow-y-auto">
                ...
                {navigationItems.map((item) => {
                  ...
                  return (
                    <button
                      key={item.href}
                      onClick={() => scrollToSection(id)}
                      className={`px-4 py-3 rounded-xl text-left text-xs font-medium tracking-wide transition-all cursor-pointer ${
                        isActive
              ...
              <div className="border-t border-zinc-800/60 pt-4 flex flex-col space-y-2.5">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl text-xs font-bold bg-zinc-900 border border-zinc-800 text-white transition-all hover:bg-zinc-800 cursor-pointer"
                >
